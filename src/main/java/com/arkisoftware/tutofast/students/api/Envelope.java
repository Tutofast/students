package com.arkisoftware.tutofast.students.api;

import com.arkisoftware.tutofast.students.application.Error;
import lombok.Value;
...
public class Envelope {
    ...
    public static Envelope ok(Object result) { return new Envelope(result, new ArrayList<Error>()); }
